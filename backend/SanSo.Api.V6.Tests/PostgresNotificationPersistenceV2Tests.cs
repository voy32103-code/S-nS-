...
public sealed class PostgresNotificationPersistenceV2Tests
{
    [Fact]
    ...
    private static async Task Execute(NpgsqlConnection c, NpgsqlTransaction tx, string sql, params object[] values)
    {
